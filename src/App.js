            ...
            <Router history={history}>
                ...
                <div className="wave">
                        <button onClick={()=>{window.scrollTo(0, 0)}} className="btn btn-link mx-auto d-block">
                            <i className="fal fa-chevron-up text-dark"/>
                        </button>
                        <p className="text-center">
                            تمام حقوق مادی نرم افزار سنجاب متعلق به شرکت

                            <a href="http://noavaran-sharif.ir" className="px-1"> نـوآوران سلامت گستر شریف </a>
                            می باشد
                        </p>
                    </div>
