                ...
                >
                    ...
                    <div className="py-3 bg-white rounded">
                        <div className="container">
                         ...
                         <button onClick={this.search} className="btn w-100 btn-primary iran-sans_Bold text-center p-2 rounded-pill  text-white"> انتخاب اعضا</button>
                            ...
                            <div className="row ">
                                <div className="col-lg-12 m-auto ">
                                    <div className="form-group mt-3   w-100">
                                        <input type="text"
                                               className="form-control rounded-pill       py-4   text-center text-blue"
                                ...
                                <div className="col-lg-5 bg-white d-flex justify-content-center pl-0 ">
                                    <div className="bg-blue  px-3 d-flex align-items-center   justify-content-center  col-sm-3" style={{minHeight:300}}>
                                        <button
                                            ...
                                            style={{minWidth:300}}> اعضای بیمارستان</button></div>
                                    <div className="d-flex flex-column align-items-start justify-content-start mx-1  " >
                                        <div className="overflowY overflow-hidden pl-5" style={{maxHeight:600}}>
                                            {loadCommittees && <img src={Loading2} alt="در حال پردازش اطلاعات" style={{maxWidth:'100%'}}/>}
