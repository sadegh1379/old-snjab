    ...
    return(
        props.final?
            <span className="btn  title" >
                <img className="" src={props.icon} width="50px" height="50px"/>
                <span className="lalezar h5 mx-2  "> {props.children}</span>
            </span>
            :
            <NavLink className="btn  title" to={props.to}>
                <img className="" src={props.icon} width="50px" height="50px"/>
                <span className="lalezar h5 mx-2 showOnHover"> {props.children}</span>
            </NavLink>
    )
}
    ...
    return(
        <nav className="navbar navbar-expand-lg navbar-light bg-light header-Sec">
            <div className="container-fluid">
                ...
                <button onClick={goBack} className="btn btn-return bg-blue rounded-pill iran-sans text-white px-5">بازگشت</button>
            </div>
        </nav>
    )
}
