...
class ErrorReport extends React.Component{
    ...
    submitErrorAPI=(params)=>{
        ...
        if(this.hideAtHospital('23') && params.report_type){
            ...
            if(!params.conditions){
                userActions.failure('لطفاً عوامل و شرایط ایجاد کننده خطا را وارد کنید.')
                return false;
            }
            if(!params.actions){
                userActions.failure('لطفاً عوارض یا مشکلات ایجاد شده را وارد کنید.')
                return false;
            }
            if(!params.suggestions){
                userActions.failure('لطفاً پیشنهادات جهت پیشگیری از موارد مشابه را وارد کنید.')
                return false;
            }

        }
        if(this.hideAtHospital('26') && params.report_type){
            if(!params.error_ward){
                userActions.failure('لطفاً بخش بروز خطا را انتخاب کنید.')
                return false;
            }
    ...
    render(){
        ...
        return (
            <form onSubmit={this.submitError} className="w-100 bg-dr py-5 error_report" style={{minHeight:'100%'}}>
                ...
                <div className="container bg-white rounded shadow position-relative mt-5 mb-2 infoBaseForm ">
                    ...
                    <div className="row pt-5 ">
                       ...
                       {/*     <label className="text-right w-100 py-2 iran-sans_Bold">بخش گزارش دهنده خطا
                        ...
                        <div className="col-12 col-md-6 col-lg-4 p-4">
                            <label className="text-right w-100  iran-sans_Bold">ارزیابی خطر سقوط(عددی بین ۱ تا ۱۰)</label>
                            <input type="text"
                                   className="form-control rounded-pill text-center shadow-sm"
                                   style={{borderColor:'#efefef'}}
                ...
                <div className="container bg-white rounded shadow position-relative mt-5 mb-2 infoBaseForm ">
                    <h3 className="rounded-pill h5 iran-sans_Bold  px-5 bg-secondary text-white position-absolute p-2" style={{top:-15,right:30}}>
                        {this.hideAtHospital('23') &&
                        <span className=" text-danger px-2" style={{fontSize:'1.5em'}}>*</span>
                        }                        عوامل و شرایط ایجاد کننده خطا</h3>
                    <div className="row pt-4 ">
                        <div className="col-12 py-1 px-3">
                            <textarea
                                name="conditions"
                ...
                <div className="container bg-white rounded shadow position-relative mt-5 mb-2  infoBaseForm">
                    <h3 className="rounded-pill h5 iran-sans_Bold  px-5 bg-secondary text-white position-absolute p-2"
                        ...
                        {this.hideAtHospital('23') &&
                        <span className=" text-danger px-2" style={{fontSize:'1.5em'}}>*</span>
                        }                        پیشنهادات جهت پیشگیری از موارد مشابه
                    </h3>
                    <div className="row pt-4  ">
                        <div className="col-12 py-1 px-3">
                            <textarea
                ...
                <div className="d-flex justify-content-center align-items-center mt-5 mb-5 ">
                    <button type="submit" className="btn btn-secondary py-2 mx-5 rounded-pill iran-sans_Bold" style={{minWidth:300 ,fontSize:12}}>ثبت گــزارش</button>
