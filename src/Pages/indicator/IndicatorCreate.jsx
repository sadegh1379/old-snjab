                ...
                if (this.step2Condition()) {
                    if (this.step3Condition()) {
                        if (this.step4Condition()) {
                            ...
                            console.log('formul : ' ,formula)

                            indicator.year = this.props.globalStorage.year;
                            indicator.hospital_id = this.props.globalStorage.me.hospital_id;
                            const menu_items = indicator.selectedItems.filter(item => !item.checked).map(item => ({parent_item_id: item.answerer_info_menu_item_id , require : item.require}));
                            if (indicator_id) {
            ...
            <div className="content bg-light py-3 px-3 ">
                ...
                <div className="container-fluid">
                    <div className="note bg-white my-5 mx-sm-5 mx-3">
                        <AdminMessage text="کاربر گرامی: با توجه به پیچیدگی و حجیم
                            بودن اطلاعات، ثبت شناسنامه شاخص به 5 بخش تقسیم شده است. لطفا توجه داشته باشید که هر 5 بخش را
                            تکمیل نمایید"/>
                    </div>
                    <Prompt
                        when={!save}
                        message="آیا از عدم ثبت تغییرات مطمئن هستید؟"
                    />
