...
class IndicatorIndex extends React.Component {
    ...
    exportExcle=()=>{
        ...
        this.props.globalStorage.indicators.map(indicator=>{
            ...
            Exceldata.data.push({'عنوان شاخص':indicator.title,'تارگت':indicator.target,'حد بالا':indicator.upper_limit,'حد پایین':indicator.lower_limit,})
        })
                            ...
                            <div className="col-lg-6  my-1">
                                <div className="card-deck ">
                                    <div className="card text-center borderDarkpurple ">
                                        <div className="card-body">
                                            <p className="card-title Darkpurple ">
                                                <small className="Darkpurple lalezar"> کل شاخص های بیمارستانی</small>
                                            </p>
                                    ...
                                    <div className="card text-center borderbluecolor">
                                        <div className="card-body">
                                            <p className=" card-title">
                                                <small className="bluecolor lalezar"> شاخص های الـزامی</small>
                                            </p>
                                    ...
                                    <div className="card text-center borderlightBlue">
                                        <div className="card-body">
                                            <p className=" card-title">
                                                <small className="lightBlue lalezar"> شاخص های اختیـاری</small>
                                            </p>
                                ...
                                <div className="card-deck ">
                                    <div className="card text-center borderOrange">
                                        <div className="card-body">
                                            <p className=" card-title">
                                                <small className="orange lalezar"> شاخص های ایمنی</small>
                                            </p>
                                    ...
                                    <div className="card text-center borderGreen">
                                        <div className="card-body">
                                            <p className=" card-title">
                                                <small className="green lalezar"> شاخص های مـوقت</small>
                                            </p>
                                    ...
                                    <div className="card text-center borderLightpurple">
                                        <div className="card-body">
                                            <p className=" card-title Lightpurple">
                                                <small className="Lightpurple lalezar"> شاخص های ارسال شده</small>
                                            </p>
                                                        ...
                                                        <div className="card-body border-0 d-flex">
                                                            <NavLink className="d-flex flex-column align-items-center   indexs    btn"
                                                                ...
                                                                <img src={conceptIcon} alt="" width="95"
                                                                     height="95"/>
                                                                <span className="lalezar text-center text-dark my-2">  فهرست شاخص‌ها</span>
                                                            </NavLink>
                                                        </div>
                                                    </div>
                                                    <div className="card text-center border-0">
                                                        <div className="card-body border-0">
                                                            <NavLink className="d-flex flex-column align-items-center      indexs btn"
                                                                ...
                                                                <img src={addIcon}  alt="" width="95"
                                                                     height="95"/>
                                                                <span className="lalezar text-center text-dark my-2">  ثبت شاخص</span>
                                                            </NavLink>
                                                        </div>
                                                    </div>
                                                    <div className="card text-center border-0">
                                    ...
                                    <div className="card border-0 shadow bg-gray2">
                                        <div className="card-body ">
                                            <div className="d-flex justify-content-between    my-lg-1 pb-2">
                                                <div className="iran-sans text-white  ">نمــودار تعداد شاخص ها به تفکیک بخش</div>
