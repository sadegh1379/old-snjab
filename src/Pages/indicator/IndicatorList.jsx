...
class IndicatorList extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            status: '',
            statuses: [{label: 'ارسال شده', value: true}, {label: 'ارسال نشده', value: false}],
            ward: '',
            sources_1: '',
            sources_2: '',
            safety_related: '',
                ...
                headers: [
                    {
                        ...
                        getData: (item, index) => {
                            return item.send_to_kartabl ?
                                <span
                                    className="px-4 py-1 rounded-pill border-inherit border text-success iran-sans_Bold">ارسال شده</span>
                                :
                                <span
                                    className="px-4 py-1 rounded-pill border-inherit border text-danger iran-sans_Bold">ثبت موقت</span>
                                ;
                        },
                        style: {
                            width: '10%'
                        ...
                        title: 'عملیات',
                        getData: (item, index) => {
                            return <button className="btn btn-blue  rounded-pill px-2  w-75" onClick={() => {
   ...
   /* getCountIndicator=()=>{
    ...
    //         >
            <div className="content bg-light py-3 px-3 pb-5">
                ...
                <div className="container-fluid">
                    ...
                    <div className="note bg-white mx-sm-5 mx-3 py-3">
                        ...
                        <div className="row d-flex justify-content-center my-4 " onClick={() => {
                            ...
                            <div className="bg-blue border border-primary  h-25 w-25 my-3"></div>
                            <button  className="btn btn-link px-3 py-0"><img src={SEARCH_ICON} alt="" width="35"
                                                       height="35"/></button>
                            <div className="bg-blue border border-primary   h-25 w-25 my-3"></div>
                        </div>
                        {advance_search && <div className="animated fadeIn">
                            <div className="d-flex justify-content-center px-sm-5 ">
                                <div className="col-md-4  col-sm-8  ">
                                    <div className="select-wrapper">
                                        <div className="form-group text-right ">
                                            <label className="iran-sans_Bold text-right  py-2">بخش یا واحد</label>
                                ...
                                <div className=" col-md-4   col-sm-8  ">
                                    <div className="select-wrapper">
                                        <div className="form-group text-right ">
                                            <label className="iran-sans_Bold text-right  py-2">نـوع شاخص</label>
                                            <Select className="text-justify custom-select-2"
                            ...
                            <div className=" d-flex justify-content-center px-sm-5 my-3">
                                <div className="  col-md-4  col-sm-8  ">
                                    <div className="select-wrapper">
                                        <div className="form-group text-right ">
                                            <label className="iran-sans_Bold text-right  py-2"> مطلوبیت</label>
                                            <Select className="text-justify custom-select-2"
                                                    value={desirability}
                                                    name="desirability"
                                                    placeholder=""
                                ...
                                <div className="  col-md-4  col-sm-8  ">
                                    <div className="select-wrapper">
                                        <div className="form-group text-right ">
                                            <label className="iran-sans_Bold text-right py-2"> وضعیت</label>
                                            <Select className="text-justify custom-select-2"
                                                    value={status}
                                                    name="status"
                                                    placeholder=""
                            ...
                            <div className=" d-flex justify-content-center px-sm-5 my-3">
                                <div className="col-md-4  col-sm-8  ">
                                    <div className="select-wrapper">
                                        <div className="form-group text-right ">
                                            <label className="iran-sans_Bold text-right  py-2">مسئـول جمع آوری</label>
                                            <Select className="text-justify custom-select-2"
                    ...
                    <div className="note bg-white my-5 mx-sm-5 mx-3 py-4">
                        {count>0 && <HospitalTable
                            ...
                            title="شناسنامه شاخص های بیمارستان"
                ...
                >
                    ...
                    {indicator && <div className="indicator_operation bg-white container">
                        ...
                        <div className="bg-secondary row pt-2">
                            <p style={{fontSize:'1em', }} className="text-center iransansBold  text-white h5 py-1 w-100">عملیات شاخص</p>
                        </div>
                            ...
                            <div className="container-fluid">
                                ...
                                <div className="row d-flex justify-content-center">
                                    <div
                                        className="operation-item d-flex flex-column align-items-center col-xl-2 col-lg-3 col-md-6">
                                        <button 
                                        onClick={() => this.props.dispatch(userActions.print(this.printRef, indicator.title))}
                                                className="btn text-white p-3">
                                            <img style={{width:70,}} src={printer} alt="printer"/>
                                        </button>
                                        <span className="iran-sans_Bold my-2">چاپ</span>
