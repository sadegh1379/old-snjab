                ...
                <div className="step-content py-3">
                    ...
                    <div className="row justify-content-center">
                        <div className="form-group text-right col-sm-5 col-10">
                            ...
                            <input type="text" className="form-control rounded-pill border-0"
                                   name="title"
                                   value={title}
                        ...
                        <div
                            ...
                            <label className="color-dark iran-sans_Bold my-3" htmlFor="creation_date">تاریخ
                                تدوین</label>
                        ...
                        <div
                            className="d-flex flex-column justify-content-center text-right col-sm-5 col-10">
                            <label className="color-dark iran-sans_Bold my-3" htmlFor="edit_date">تاریخ بازنگـری</label>
                            <div className="input-group-prepend">
                                <i className="fas fa-calendar-alt color-dark"></i>
                            </div>
                            <DatePicker
                        ...
                        <div className="custom-select-box form-group text-right col-10">
                            <label className="color-dark iran-sans_Bold my-3">بخش یا واحد</label>
                        ...
                        <div className="form-group text-right col-10">
                            <label className="color-dark iran-sans_Bold my-3">تعریف شاخص و اهمیت
                                موضوع</label>
                            <textarea
                        ...
                        <div className="form-group text-right col-10">
                            <label className="color-dark iran-sans_Bold my-3">دلایل منطقی جمع آوری
                                شاخص</label>
                    ...
                    <div className="d-flex justify-content-center my-5">
                        <div className="text-right col-xl-6 col-md-9 px-0">
                            <label className="color-dark iran-sans_Bold mx-2">فــرمـول شاخص</label>
                                            ...
                                            content={({position, targetRect, popoverRect}) => (
                                                ...
                                                >
                                                    <>
                                                        ...
                                                        <div className="bg-blue rounded p-4">
                                                            <p className="text-center pb-1 text-white">مقدار صورت از
