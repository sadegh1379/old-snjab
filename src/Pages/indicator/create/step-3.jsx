    ...
    render(){
        ...
        return(
            ...
            <div className="step-content py-3">
                <h3 className="h6 text-center iran-sans_Bold pb-4">دوره تناوب اندازه گیری شاخص</h3>
                <div className="container">
                    ...
                    <h3 className="h6 text-center iran-sans_Bold mt-5">فرجه زمانی تحویل داده</h3>
                    <p className="text-center iran-sans_Bold my-4">شما می توانید به کاربران فــرجه زمانی برای اندازه
                        گیری شاخص بدهید. به عنوان مثال تا 10 روز بعد از پایان "ماه"</p>
                        ...
                        <div
                            ...
                            <input type="text" className="form-control text-center w-75 my-3 py-4"
                                ...
                                <div className="final-date row">
                                    <p className="iran-sans_Bold my-0">روز بعد از</p>
