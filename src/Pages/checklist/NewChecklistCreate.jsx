...
class ChecklistCreate_ extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            new_component_title : '',
            component_edit_index : null ,
            component_is_edit : false,
            questions: [],
            selectedType: null,
            questionGroupByTypes: {},
            questionTypes: userActions.generateSelectLabelValue(['دوسطحی', 'عددی', 'سوال باز']),
            valuesHeader: [
                {
                    ...
                    <div className="container-fluid shadow rounded  py-4 px-3 px-lg-5 bg-white ">
                                                ...
                                                <div className="row d-flex justify-content-center mt-3">
                                                    ...
                                                    <div className="d-flex flex-column align-items-center mb-3 ">
                                                        <UsersSelect className="btn animated bounceInUp rounded-pill"
                                                            ...
                                                            <img data-tip="افــزودن مسئول جمع آوری" src={AddIcon}
                                                                width="50px"
                                                                height="50px"
                        ...
                        <div>
                            <div style={{display:'flex' , flexDirection:'row' , justifyContent:'center' , alignItems:'center'}}>
                                <AcceptButton onclick={() => this.saveChecklist(true)} title="ثبت موقت" w="20%" h={35} />
                                <AcceptButton onclick={() => this.saveChecklist()} title="ثبت نهایی" w="20%" h={35} />
                                <RejectButton onclick={this.goBack} title="بازگشت" w="20%" h={35} />
                            </div>
                        </div>
...
const NewChecklistCreate = connect((state) => ({ globalStorage: state.globalStorage }))(ChecklistCreate_);
export { NewChecklistCreate }
