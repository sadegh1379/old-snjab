                    ...
                    (
                        <>
                            ...
                            <div className="container bg-white shadow rounded ">
                                <div className="row">
                                    <div className="col-lg-5  col-sm-12 bg-blue  rounded-right">
                                        <div className="d-flex flex-column align-items-center py-4  ">
                                            ...
                                            <div className="w-100 text-right px-3">
                                                <label
                                                    className="description  shadow-sm border px-4 rounded-pill bg-white ">توضیحات </label>
                                                <div
                                                    className=" pt-4  rounded overflow-hidden w-100 bg-white shadow-sm"
                                                    style={{height: 300}}>
                                                 <textarea
                                                     name="text"
                                                     onChange={userActions.handleChangeInput.bind(this)}
                                                     className="shadow-none border-0 form-control w-100 h-100" value={this.state.text}></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            {q.content.sort((a, b) => {
                                                ...
                                                <div className="row mx-0   " key={h}>
                                                    <div className="width-5 text-center text-iransans py-1 ">
                                                        <p className={`${h % 2 && "question-row"} shadow-sm mx-1 my-0 py-3 text-center CustomHeight`}>{h + 1}</p>
                                                    </div>
                                                    <div
                                                        className={` text-center text-iransans py-1 ${question.question_type == 'سوال باز' ? 'width-95' : 'w-70'} `}>
                                                        <p className={`${h % 2 && "question-row "} shadow-sm mx-1 my-0 py-2 text-center CustomHeight`}>
                                                            {question.question}
                                                        </p>
                                                    </div>
...
class Print extends React.Component {
    ...
    render() {
        ...
        return (
            hospital && indicator ?
                <>
                    <div className="container-fluid  my-3 printIndexForm">
