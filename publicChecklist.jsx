                        ...
                        return (
                          <>
                            <div key={i} style={{backgroundColor: "#f0f3f8"}} className="col-12 col-md-4 rounded my-2 p-4">
                                  <p className="text-center iran-sans_Bold">
                                      {checklist.title}
                                  </p>
                                  <div className="d-flex justify-content-between mt-3 p-3 bg-white rounded">
                                      ...
                                      <span
                                        ...
                                        style={{ width: 40, height: 40, lineHeight: "30px" }}
                                      >
                                        <i style={{fontSize: "20px"}} className={checklist.mehvar_icon} data-tip={checklist.mehvar} />
                                        <ReactTooltip type="light" />
                                      </span>
                                      </div>
                                      <div className="p-2">
                              ...
                              <div className="bg-white px-3 pt-3 my-3 rounded  shadow">
                                ...
                                <div className="row">
                                  ...
                                  {question.question_type !== 'سوال باز' && question.answers && question.answers.map((a, z) =>
                                    ...
                                    <label key={z}
                                      className={`m-0 d-flex justify-content-center text-center text-iransans  py-3  position-relative   `}
                                      style={{ width: (100 / question.answers.length) + '%' }}>
                                      <input type="checkbox"
                                        className="d-none"
                                        name={i + '-' + h}
                                        value={a.answer}
